...
template <typename E>
class HuffTree :public HuffNode<E>{
private:
...
public:
	...
	/*template <typename E,typename minTreeComp> HuffTree<E>*
...
template <typename E> class minTreeComp:public HuffTree<E>, Comp {
public:
	bool prior(HuffTree e1, HuffTree e2)
	{
