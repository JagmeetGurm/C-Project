...
namespace UserInfoDatabase {
    ...
    public partial class UserDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class UserInfoDataTable : global::System.Data.TypedTableBase<UserInfoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UserInfoRow AddUserInfoRow(string First_Name, string Last_Name, string User_Name, string PassWord) {
...
namespace UserInfoDatabase.UserDatabaseDataSetTableAdapters {
    ...
    public partial class UserInfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[UserInfo] WHERE (([Id] = @Original_Id) AND ([First Name] = @Or" +
                "iginal_First_Name) AND ([Last Name] = @Original_Last_Name) AND ([User Name] = @O" +
                "riginal_User_Name) AND ([PassWord] = @Original_PassWord))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[UserInfo] ([First Name], [Last Name], [User Name], [PassWord])" +
                " VALUES (@First_Name, @Last_Name, @User_Name, @PassWord);\r\nSELECT Id, [First Nam" +
                "e], [Last Name], [User Name], PassWord FROM UserInfo WHERE (Id = SCOPE_IDENTITY(" +
                "))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[UserInfo] SET [First Name] = @First_Name, [Last Name] = @Last_Name, [User Name] = @User_Name, [PassWord] = @PassWord WHERE (([Id] = @Original_Id) AND ([First Name] = @Original_First_Name) AND ([Last Name] = @Original_Last_Name) AND ([User Name] = @Original_User_Name) AND ([PassWord] = @Original_PassWord));
SELECT Id, [First Name], [Last Name], [User Name], PassWord FROM UserInfo WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::UserInfoDatabase.Properties.Settings.Default.UserDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, [First Name], [Last Name], [User Name], PassWord FROM dbo.UserInfo";
        ...
        public virtual int Fill(UserDatabaseDataSet.UserInfoDataTable dataTable) {
        ...
        public virtual UserDatabaseDataSet.UserInfoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UserDatabaseDataSet.UserInfoDataTable dataTable = new UserDatabaseDataSet.UserInfoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserDatabaseDataSet.UserInfoDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_First_Name, string Original_Last_Name, string Original_User_Name, string Original_PassWord) {
        ...
        public virtual int Update(string First_Name, string Last_Name, string User_Name, string PassWord, int Original_Id, string Original_First_Name, string Original_Last_Name, string Original_User_Name, string Original_PassWord, int Id) {
            if ((First_Name == null)) {
                throw new global::System.ArgumentNullException("First_Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string First_Name, string Last_Name, string User_Name, string PassWord, int Original_Id, string Original_First_Name, string Original_Last_Name, string Original_User_Name, string Original_PassWord) {
            return this.Update(First_Name, Last_Name, User_Name, PassWord, Original_Id, Original_First_Name, Original_Last_Name, Original_User_Name, Original_PassWord, Original_Id);
        }
    }
